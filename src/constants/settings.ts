...
export const SETTING_ADD_CREATED_IF_EMPTY_ON_SAVE = "taxonomy.addCreatedIfEmptyOnSave";
export const SETTING_UPDATE_MODIFIED_ON_SAVE = "taxonomy.updateModifiedOnSave";
...
export const SETTING_FILENAME_PATTERN = "taxonomy.filenamePattern";
